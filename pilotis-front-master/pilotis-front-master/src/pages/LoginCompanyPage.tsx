            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 relative">
                ...
                <div className="w-full max-w-md space-y-10 relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 mb-3">Bon retour</h1>
                        <p className="text-gray-500 text-lg">Espace Entreprise : Connectez-vous en tant qu'Administrateur.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="pt-4 text-center">
                            <p className="text-gray-500">
                                Pas encore d'espace Entreprise ?{" "}
                                <Link
                                    to="/register-company"
                        ...
                        <div className="pt-5 mt-2 border-t border-gray-100 text-center">
                            <Button
                                type="button"
                                variant="outline"
                                onClick={() => navigate('/login')}
                                className="w-full flex items-center justify-center gap-2 h-12 border-gray-200 text-[#003060] hover:bg-gray-50 rounded-xl"
                            >
