...
Elle intègre l'intelligence artificielle (Qwen), l'OCR (Tesseract) et des intégrations externes (BoondManager, LinkedIn, Gmail, Google Drive, Apify, Calendly) 
pour offrir une solution complète de pilotage commercial et de gestion des talents.

🎯 Objectifs du Projet
✅ Centraliser les données commerciales
✅ Automatiser les traitements (OCR, IA, collecte CV)
✅ Suivre les KPI en temps réel
✅ Matching intelligent candidats/offres
✅ Générer du contenu LinkedIn
✅ Collecter automatiquement les candidatures
✅ Scraper les interactions LinkedIn

📸 Captures d'écran de l'Application
1. Page d'Authentification
<img width="942" height="567" alt="image" src="https://github.com/user-attachments/assets/831cafcc-d279-48e4-80a1-90e65fc0f830" />
